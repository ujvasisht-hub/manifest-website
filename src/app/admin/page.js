...
const AdminPage = () => {
  ...
  const fetchWorkshops = async () => {
    ...
    if (data) {
      setAllSessions(data);
      setFilteredSessions(data); // Initially, show all sessions

      // Calculate stats based on unique events
  ...
  // ... (keep all your handle functions: handleEventChange, etc.)
