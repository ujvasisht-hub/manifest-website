...
const AdminPage = () => {
  ...
  // ... (all your handle functions: handleEventChange, etc.)
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allWorkshops.map((workshop) => (
                <tr key={workshop.id}>
                  ...
                  {/* Display date and time of the first session */}
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{workshop.workshop_sessions[0]?.date || 'N/A'}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{workshop.workshop_sessions[0]?.time || 'N/A'}</td>
