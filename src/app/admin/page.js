              ...
              {Object.values(groupedByEvent).map((event) => (
                <React.Fragment key={event.id}>
                  ...
                  <tr className="bg-gray-100">
                    <td className="px-6 py-4 font-bold text-gray-900" colSpan="2">{event.title}</td>
                    <td className="px-6 py-4 font-bold text-gray-600" colSpan="3">{event.artist_name}</td>
                  ...
                  {event.sessions.map(session => (
                    <tr key={session.id}>
                      <td colSpan="2"></td>
                      <td className="px-6 py-4 text-sm text-gray-700">{session.session_title}</td>
