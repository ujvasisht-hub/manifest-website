                ...
                <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-4 relative">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center">
                      <input type="checkbox" name="is_active" id={`session_is_active_${index}`} checked={session.is_active} onChange={(e) => handleSessionChange(index, e)} className="h-4 w-4 text-teal-600 border-gray-300 rounded"/>
                      <label htmlFor={`session_is_active_${index}`} className="ml-2 block text-sm font-medium text-gray-900">Active</label>
                    </div>
                  </div>
