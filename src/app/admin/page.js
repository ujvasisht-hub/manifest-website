      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <img
              src="/images/your-studio-image-1.jpg" // Replace with your image file name
              alt="Studio space"
              className="w-full h-48 object-cover rounded-lg shadow-md"
            />
            <img
              src="/images/your-art-supplies-image.jpg" // Replace with your image file name
              alt="Art supplies"
              className="w-full h-48 object-cover rounded-lg shadow-md"
            />
          </div>
          <img
            src="/images/your-workshop-image.jpg" // Replace with your image file name
            alt="Workshop in progress"
            className="w-full h-64 object-cover rounded-lg shadow-md"
          />
          <img
            src="/images/your-workspace-image.jpg" // Replace with your image file name
