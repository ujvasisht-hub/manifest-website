...
const AdminPage = () => {
  ...
  // ... (keep all your handle functions: handleEventChange, handleFileChange, handleSessionChange, addSession, removeSession)
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-3">
        <StatCard title="Total Workshops" value={stats.total} />
        <StatCard title="Active Workshops" value={stats.active} />
        <StatCard title="Inactive Workshops" value={stats.inactive} />
      </div>

      {/* New Workshop List Section */}
      <div className="mt-12">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {allWorkshops.map((workshop) => (
                <tr key={workshop.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{workshop.artist_name}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{workshop.workshop_sessions[0].count}</td>
      ...
      {/* Existing Create Form Section */}
      <div className="mt-12">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Create New Workshop Event</h2>
        </div>
