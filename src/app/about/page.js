    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            At Manifest by TMN, we partner with talented local and international artists who bring their expertise and passion to every workshop. Our mission is to democratize access to quality art education while fostering a supportive community where creativity thrives and artistic boundaries are pushed.
          </p>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <img
              src="/images/your-studio-image-1.jpg" // Replace with your image path
              alt="Studio space"
              className="w-full h-48 object-cover rounded-lg shadow-md"
            />
            <img
              src="/images/your-art-supplies-image.jpg" // Replace with your image path
              alt="Art supplies"
              className="w-full h-48 object-cover rounded-lg shadow-md"
            />
          </div>
          <img
            src="/images/your-workshop-image.jpg" // Replace with your image path
            alt="Workshop in progress"
            className="w-full h-64 object-cover rounded-lg shadow-md"
          />
          <img
            src="/images/your-workspace-image.jpg" // Replace with your image path
